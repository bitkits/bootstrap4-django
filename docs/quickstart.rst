...
After :doc:`installation`, you can use ``bootstrap4-django`` in your templates.:
...
You can set defaults for ``bootstrap4-django`` in your settings file. Refer to :doc:`settings` for more information.
